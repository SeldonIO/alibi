...
# mock imports
autodoc_mock_imports = ['pandas', 'sklearn', 'skimage', 'requests', 'prettyprinter',
...
latex_documents = [
    (master_doc, 'alibi.tex', 'alibi Documentation',
     'Seldon Technologies Ltd', 'manual'),
]
...
man_pages = [
    (master_doc, 'alibi', 'alibi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'alibi', 'alibi Documentation',
     author, 'alibi', 'One line description of project.',
     'Miscellaneous'),
]
