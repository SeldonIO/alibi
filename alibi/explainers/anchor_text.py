...
class AnchorText(object):
        ...
        **kwargs
        ...
        def sample_fn(
            ...
            if use_unk:  # perturb examples by replacing words with UNKs
                ...
                raw_data, data = self.perturb_sentence(
                    text,
                    present,
                    num_samples,
                    top_n=top_n,
    ...
    def explain(
        ...
        **kwargs: Any
        ...
        words, positions, sample_fn = self.get_sample_fn(
            text,
    ...
    def perturb_sentence(
        ...
        **kwargs
        ...
        for i, t in enumerate(tokens):  # apply sampling to each token
            ...
            if (
                t.text not in forbidden_words
                and t.pos_ in pos
                and t.lemma_ not in forbidden
                and t.tag_ not in forbidden_tags
            ):
