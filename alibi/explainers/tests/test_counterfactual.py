...
def tf_keras_logistic_mnist():
    ...
    y = tf.keras.utils.to_categorical(y_train[:1000], nb_classes)
...
def keras_logistic_mnist():
    ...
    y = keras.utils.to_categorical(y_train[:1000], nb_classes)
...
def test_keras_mnist_explainer(keras_mnist_explainer):
