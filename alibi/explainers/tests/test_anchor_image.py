...
from alibi.explainers.tests.utils import get_fashion_mnist_dataset


# Data preparation
x_train, y_train = get_fashion_mnist_dataset()


@pytest.mark.parametrize('conv_net', ((x_train, y_train),), indirect=True)
