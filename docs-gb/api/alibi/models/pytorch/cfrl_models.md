...
## Classes
### `ADULTDecoder` (_inherits from `Module`)
...
### `ADULTEncoder` (_inherits from `Module`)
...
### `MNISTClassifier` (_inherits from `Model`, `Module`)
...
### `MNISTDecoder` (_inherits from `Module`)
...
### `MNISTEncoder` (_inherits from `Module`)
